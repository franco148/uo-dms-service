package com.umssonline.dms.core.utils.constants;
...
public class DMSConstants {
    ...
    public static final String DMS_VERSION_ID = "DMSVERSIONID";
    public static final String DMS_QUERY_PARAMETERS = "QUERY_PARAMETERS";
    public static final String DMS_PROPERTY_NAME = "PROPERTY_NAME";
    public static final String DMS_PROPERTY_VALUE = "PROPERTY_VALUE";
    ...
    public static final String OAK_INDEX_PARAM = "oak:index";
    ...
    public static final String TIKA_CONFIG_PATH = "tika-config.xml";
    ...
    public static final String DMS_IS_SYSTEM_FOLDER="IsSystemFolder";
    public static final String DMS_IS_FOLDER="IsFolder";
    public static final String DMS_EXPIRED="Expired";
    public static final String DMS_CONTEXT_CURRENT_SCREEN="ContextCurrentScreen";
    public static final String DMS_FILE_CONTENT="fileContent";
    public static final String DMS_SAML_TOKEN="SAMLToken";
    public static final String DMS_CREATE_QUERY_CTTE = "JCR-SQL2";
    public static final String DMS_FOLDER_ATTRIBUTES = "FOLDER_ATTRIBUTES";
    public static final String DMS_ATTRIBUTES = "ATTRIBUTES";
    public static final String DMS_ID_PROPERTY = "dmsId";
    public static final String DMS_VERSION_ID_PROPERTY = "jcrUuId";
    ...
    /*Default values*/
    public static final String DEFAULT_DMS_ID = "-1";
