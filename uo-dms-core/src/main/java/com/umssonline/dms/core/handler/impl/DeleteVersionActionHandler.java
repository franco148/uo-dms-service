 ...
 */
public class DeleteVersionActionHandler implements ActionHandler {

    //region Fields
    private static Logger logger = LoggerFactory.getLogger(DeleteVersionActionHandler.class);
    //endregion
    ...
    public Object handle(Map<String, Object> params) throws RepositoryException, IOException, IllegalAccessException {
        logger.info("DeleteVersionActionHandler.handle() method");
        ...
        return metadataManager.removeVersion(dmsId, versionId);
    }
    //endregion
}
